...
class Thread extends Eloquent
{
    ...
    {
        return $this->belongsToMany(Models::classname(Client::class), Models::table('participants'), 'thread_id', 'user_id');
    }
    ...
    public function creator()
    {
        if ($this->creatorCache === null) {
            ...
            $this->creatorCache = $firstMessage ? $firstMessage->user : Models::table('clients');
        }
    ...
    {
        $participantsTable = Models::table('participants');
        $usersTable = Models::table('clients');
        $userPrimaryKey = Models::table('clients')->getKeyName();
